...
; and the trigonometric identity sin(x) = 3sin(x/3) − 4sin^3(x/3)
...
; the order of growth is O(log a),
; because another p call will be added to the stack
; with each recursive call until a/3 is <= 0.1

; the number of steps performed is also O(log a)
